          ...
          <v-card class="pa-3" height="65">
            <v-row dense>
              <v-col cols="2">
                <v-text-field
                  label="수주번호"
                  v-model="search_condition.orderInfoCode"
                  dense
                  solo
                  rounded
                ></v-text-field>
              ...
              <v-col cols="2">
                <v-text-field
                  label="거래처명"
                  v-model="search_condition.customerName"
                  dense
                  solo
                  rounded
                ></v-text-field>
              ...
              <v-col cols="2">
                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      v-model="search_condition.order_startDate"
                      label="수주시작일"
                      readonly
                      v-bind="attrs"
                      v-on="on"
                  ...
                  >
                    ...
                    <v-btn
                      ...
                      color="primary"
                      @click="
                        s_date_search_order(search_condition.order_startDate)
                      "
                    >
                      확인
                    </v-btn>
              ...
              <v-col md="2">
                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      v-model="search_condition.order_endDate"
                      label="수주종료일"
                      solo
                      rounded
                      readonly
        ...
        <v-col class="ma-2" cols="12">
          <v-row dense class="mb-2">
            ...
            <v-col class="text-right" cols="3">
              <v-btn color="primary" @click="add" elevation="0"
                ><v-icon left> mdi-book-account </v-icon>수주 등록</v-btn
              >
            </v-col>
          </v-row>
          <!-- 수주 목록 테이블 -->
