    ...
    <v-container fluid>
      ...
      <v-row>
        <v-col class="ma-2" md="5">
          <v-row class="mb-2">
            <v-col md="2">
              <h4 class="searchbox-title">활착실3</h4>
            </v-col>
          </v-row>
      ...
      <v-row>
        <v-col class="ma-2" md="5">
          <v-row class="mb-2">
            <v-col md="2">
              <h4 class="searchbox-title">1차 육묘실1</h4>
            </v-col>
          </v-row>
      ...
      <v-row>
        <v-col class="ma-2" md="5">
          <v-row class="mb-2">
            <v-col md="2">
              <h4 class="searchbox-title">1차 육묘실2</h4>
            </v-col>
          </v-row>
      ...
      <v-row>
        <v-col class="ma-2" md="5">
          <v-row class="mb-2">
            <v-col md="2">
              <h4 class="searchbox-title">2차 육묘실1</h4>
            </v-col>
          </v-row>
      ...
      <v-row>
        <v-col class="ma-2" md="5">
          <v-row class="mb-2">
            <v-col md="2">
              <h4 class="searchbox-title">2차 육묘실2</h4>
            </v-col>
          </v-row>
...
<style src="./ShowControll.scss" lang="scss"></style>
