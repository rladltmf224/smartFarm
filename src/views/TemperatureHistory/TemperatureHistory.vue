...
import TempHumid from "@/views/EnvironmentalControl/TempHumid.vue";
import WaterpH from "@/views/EnvironmentalControl/WaterpH.vue";
...
<style lang="scss" src="./TemperatureHistory.scss" scoped></style>
